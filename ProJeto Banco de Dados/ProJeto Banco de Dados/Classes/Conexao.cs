    ...
    public class Conexao
    {
        ...
        public static void CriarProcedure()
        {
            try { 
                ...
                string cmd_procedure = System.IO.File.ReadAllText(@"D:\Projetos\PROJETO_CONTROLE_DE_DISPOSITIVOS_MOVEIS\ProJeto Banco de Dados\ProJeto Banco de Dados\Resources\TextFile1.txt");
